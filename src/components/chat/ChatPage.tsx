...
import { RouteInfo, RouterPageProps, SwitchRoutes } from '../../routes';
    ...
    <div className="relative flex h-screen">
      ...
      >
        <ChatSidebar
          ...
          className="fixed z-40 w-sidebar bg-white text-black shadow h-full transform transition-all duration-300"
        />
      </CSSTransition>
      <div id="chat-area" className="flex-1 flex flex-col">
